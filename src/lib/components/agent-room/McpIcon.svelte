<script lang="ts">
  let { size = 14, ...rest }: { size?: number; [key: string]: unknown } = $props();
</script>

<svg {...rest} width={size} height={size} viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd" xmlns="http://www.w3.org/2000/svg">
