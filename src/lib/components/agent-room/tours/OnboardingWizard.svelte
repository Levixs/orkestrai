<script lang="ts">
  ...
  import {
    Activity, ArrowLeft, Cable, FileCode2, FolderPlus, GitBranch, GitPullRequestArrow, Languages, Layers, LayoutGrid, LayoutTemplate, Mic, Palette, PanelLeftOpen, Pin, RadioTower, Repeat, Rocket, Scale, ScanSearch, Search, Sparkles, Users, Workflow,
  } from '@lucide/svelte';
  ...
  const ICONS: Record<string, typeof Users> = { Users, Repeat, GitBranch, GitPullRequestArrow, Workflow, Search, FolderPlus, Cable, Rocket, Layers, LayoutGrid, LayoutTemplate, Palette, PanelLeftOpen, FileCode2, Pin, RadioTower, Mic, Languages, Activity, Scale, ScanSearch };
