<script lang="ts">
  ...
  import {
    ArrowLeft, Cable, FolderPlus, GitBranch, Languages, Layers, Mic, Palette, RadioTower, Repeat, Rocket, Search, Sparkles, Users, Workflow,
  } from '@lucide/svelte';
  ...
  const ICONS: Record<string, typeof Users> = { Users, Repeat, GitBranch, Workflow, Search, FolderPlus, Cable, Rocket, Layers, Palette, RadioTower, Mic, Languages };
