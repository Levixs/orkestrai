    ...
    steps: [
      {
        ...
        title: 'Abre Dispositivo móvil',
        body: 'En Workbench, expande el workspace activo y abre Dispositivo móvil en Herramientas. Orkestrai lista los runtimes de iOS Simulator disponibles en este Mac Apple Silicon.',
