...
export const TOURS_ES: Tour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'automate-and-test', title: 'Ejecuta scripts en su runtime de origen', body: 'Elige Postman, Bruno o Nativo en Scripts. JavaScript, variables, assertions y bloques tests importados se ejecutan con el runtime oficial compatible, ámbitos separados, callbacks de solicitud, bibliotecas incluidas, flujo de colección, pruebas Chai, cookies, visualizaciones y vault cifrado en el escritorio. Agrega un objeto JSON por iteración del runner para proporcionar datos de iteración correctos y sincroniza archivos Bruno/OpenCollection vinculados.' },
