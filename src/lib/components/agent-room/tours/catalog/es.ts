...
export const TOURS_ES: Tour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'agent-authoring', title: 'Delega una colección completa', body: 'Conecta el Cliente de API a un agente o líder. Mediante tools api_client_* lee con fingerprint, crea o reemplaza carpetas, solicitudes, entornos, runners, scripts y pruebas, ejecuta la suite y exporta Bruno o Postman sin exponer secretos locales.' },
