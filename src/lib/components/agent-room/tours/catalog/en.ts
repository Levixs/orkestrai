...
export const TOURS_EN: Tour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'import-collection', title: 'Bring in a contract or collection', body: 'Import Bruno, OpenCollection YAML, Postman v2.1, Swagger 2.0, OpenAPI 3.x, or a complete Orkestrai backup. OpenAPI local references remain inside the contract folder and visible notes identify any simplified REST feature.' },
      ...
      { id: 'automate-and-test', title: 'Run scripts in their native runtime', body: 'Choose Postman, Bruno, or Native in Scripts. Imported JavaScript, Bruno variables, assertions, and tests blocks run through their official compatible runtime with separate scopes, request callbacks, bundled libraries, collection flow, Chai tests, cookies, visualizers, and an encrypted desktop vault. Add one JSON object per runner iteration to feed accurate iteration data, then synchronize linked Bruno/OpenCollection files.' },
