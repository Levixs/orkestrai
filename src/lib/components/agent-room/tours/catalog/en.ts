...
export const TOURS_EN: Tour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'agent-authoring', title: 'Delegate a complete collection', body: 'Connect the API Client to an agent or lead. Through api_client_* tools it reads with a fingerprint, creates or replaces folders, requests, environments, runners, scripts, and tests, executes the suite, and exports Bruno or Postman without exposing local secrets.' },
