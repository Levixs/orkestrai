    ...
    steps: [
      {
        ...
        body: 'Abra Pedir perspectivas pelo cartão de uma tarefa ou pelo menu do líder. A tarefa fornece o briefing completo automaticamente; pelo líder, ele já começa selecionado.',
        action: { kind: 'openPage', path: '/canvas' },
      },
      {
    ...
    steps: [
      {
        ...
        title: 'Abra Dispositivo móvel',
        body: 'No Workbench, expanda o workspace ativo e abra Dispositivo móvel em Ferramentas. O Orkestrai lista os runtimes do iOS Simulator disponíveis neste Mac Apple Silicon.',
