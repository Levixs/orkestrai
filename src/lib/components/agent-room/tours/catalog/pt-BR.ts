...
export const TOURS_PT: Tour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'automate-and-test', title: 'Execute scripts no runtime de origem', body: 'Escolha Postman, Bruno ou Nativo em Scripts. JavaScript, variáveis, assertions e blocos tests importados rodam pelo runtime oficial compatível com escopos separados, callbacks de request, bibliotecas incluídas, fluxo da coleção, testes Chai, cookies, visualizações e vault criptografado no desktop. Adicione um objeto JSON por iteração do runner para alimentar dados corretos de iteração e sincronize arquivos Bruno/OpenCollection vinculados.' },
