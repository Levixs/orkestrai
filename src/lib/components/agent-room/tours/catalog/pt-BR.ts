...
export const TOURS_PT: Tour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'agent-authoring', title: 'Delegue uma coleção completa', body: 'Conecte o Cliente de API a um agente ou líder. Pelas tools api_client_* ele lê com fingerprint, cria ou substitui pastas, requests, ambientes, runners, scripts e testes, executa a suite e exporta Bruno ou Postman sem expor os segredos locais.' },
