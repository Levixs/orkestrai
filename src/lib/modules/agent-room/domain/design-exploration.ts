...
const copy: Record<CreateDesignExplorationDto['locale'], DesignExplorationCopy> = {
  'pt-BR': {
    ...
    tasks: [
      ...
      { title: '2. Produzir 3 direções completas', description: 'Produza A Clareza, B Expressiva e C Eficiente nos três documentos Design. Cada alternativa deve incluir frames responsivos e estados, tokens, componentes, protótipo, auditoria e preview de código.' },
  ...
  en: {
    ...
    tasks: [
      ...
      { title: '2. Produce 3 complete directions', description: 'Produce A Clarity, B Expressive, and C Efficient in the three Design documents. Each alternative must include responsive frames and states, tokens, components, a prototype, an audit, and a code preview.' },
  ...
  es: {
    ...
    tasks: [
      ...
      { title: '2. Producir 3 direcciones completas', description: 'Produce A Claridad, B Expresiva y C Eficiente en los tres documentos Design. Cada alternativa debe incluir frames responsivos y estados, tokens, componentes, prototipo, auditoría y vista previa de código.' },
