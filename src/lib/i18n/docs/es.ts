...
export const DOCS_ES: DocsCatalog = {
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Agrega un nodo Diseño nativo y ábrelo en el Modo Diseño del Canvas o en Workbench. Crea paths vectoriales, máscaras, gradientes, frames responsivos con auto layout y assets reutilizables o pega un SVG para convertir paths, transforms, estilos y gradientes en capas nativas editables. Agrupa o desagrupa el arte, selecciona todas las capas que usan el mismo color, reemplaza colores coincidentes en sólidos y stops de gradiente y copia la selección como SVG o PNG. En Variables, crea tokens tipados en colecciones, define modos Claro, Oscuro, marca o producto, reutiliza valores mediante aliases y vincúlalos a propiedades compatibles desde el inspector. Conecta el documento al Diseñador o líder: el agente lee la revisión actual exacta, aplica las mismas operaciones tipadas de elementos, assets, guías, layout, variables, modos y vínculos y verifica el resultado mientras tu editor se actualiza en vivo. Exporta la selección o página aprobada en SVG, PNG, JPEG, WebP o PDF. Documento, assets, miniaturas, tokens e historial de revisiones quedan en el workspace y siguen disponibles en la búsqueda junto con tareas, notas, archivos, portales y el resto del equipo.',
