  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Agentes y líderes pueden importar una colección Bruno, OpenCollection o Postman existente con api_client_import y una ruta relativa al repositorio. api_client_read/replace edita el mismo nodo visible en la UI y escribe por defecto en los orígenes vinculados; sync-status, pull y push muestran conflictos antes de reemplazar cualquiera de los lados. Las solicitudes, carpetas, scripts, pruebas y variables nativas del formato quedan en archivos comunes listos para git, Bruno, Postman y CI; la configuración de runners exclusiva de Orkestrai permanece en el nodo y en la copia nativa sin pérdidas.',
      ],
      examples: [
        {
          id: 'postman',
...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Agrega un Cliente de API e importa Bruno, OpenCollection YAML, Postman v2.1, Swagger 2.0 u OpenAPI 3.x. En un proyecto que ya contiene pruebas Bruno/Postman, pide al líder o agente usar api_client_import con la ruta relativa al repositorio: la misma colección aparece en Canvas y Workbench y las ediciones posteriores con api_client_replace persisten en los archivos originales. Organiza carpetas, entornos y runners, escribe automatización y pruebas JavaScript con autocompletado, ejecuta la suite, revisa conflictos de sincronización y luego versiona la colección modificada junto con el proyecto.',
  ...
  changelog: [
    {
      ...
      title: 'Orkestrai 0.18.5: tema Obsidian en el terminal',
      summary: 'Nuevo tema de terminal Obsidian — fondo negro puro y paleta ANSI de alto contraste.',
      items: [
        'Se agregó el tema de terminal Obsidian (fondo negro puro, paleta ANSI de alto contraste), llevando la selección de temas integrados a 11.',
      ],
    },
    {
    ...
    },
    {
      ...
      summary: 'GitHub Copilot se suma como provider de agente, y los nodos de agente en el Canvas ahora muestran la marca de cada provider en lugar de un icono genérico de terminal.',
      items: [
        'Se agregó GitHub Copilot como provider de agente, siguiendo el mismo patrón de adapter, detección y catálogo de uso que los demás providers de CLI.',
        'Los nodos de agente en el Canvas ahora muestran la marca propia de Claude, Codex, Kimi, OpenCode, Cursor, Antigravity, Cline, Devin y GitHub Copilot en el encabezado del terminal, en lugar de un icono genérico — la misma marca ya usada en Uso y en la Central de Providers.',
      ],
    },
    {
