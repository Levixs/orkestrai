...
export const DOCS_ES: DocsCatalog = {
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Abre Diseño en la barra del Canvas y elige Tres direcciones completas de UI. Indica objetivo, público, plataforma, destino del código, restricciones, referencias y si Light y Dark son obligatorios. Orkestrai crea un grupo trazable con una spec vinculada, cinco etapas en Kanban y tres documentos Diseño nativos y editables: Claridad, Expresiva y Eficiente. Trabaja manualmente o delega la primera etapa a un líder que esté activo. Cada tarea enviada incluye la spec vinculada completa, imágenes, archivos y enlaces. Los agentes consultan el contrato exacto y producen cada dirección en pocos lotes transaccionales, sin probes ni scripts de descubrimiento. Cada dirección debe entregar estados responsivos, tokens tipados, componentes reutilizables, prototipo navegable, evidencia de accesibilidad y calidad y una vista previa de código real del framework. En documentos anchos, navega con trackpad, Mano (H), Espacio+arrastrar o el botón central y usa Ajustar para encuadrar todas las pantallas. Compara marca, UX, esfuerzo y riesgo técnico; una persona debe aprobar una dirección o combinación explícita antes de aplicar código. Finaliza validando la fuente aprobada contra un Portal o dispositivo móvil y registrando el resultado vinculado a Git en Review Center.',
