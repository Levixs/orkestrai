  ...
  changelog: [
    {
      ...
      items: [
        ...
        'Portal incorpora un viewport responsivo real con barra de controles dedicada, selector de presets en portal, dimensiones exactas, rotación y desplazamiento contenido que ya no oculta controles ni recorta páginas grandes.',
