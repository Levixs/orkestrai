  ...
  changelog: [
    {
      ...
      items: [
        'La colaboración remota ahora admite conversaciones trazables vinculadas a la pregunta y sesión exactas en todos los providers registrados, dictado de mensajes al líder mediante el STT local del host, inicio o restauración solo para Administradores y un terminal sin filtrar aprobado por separado, desactivado por defecto, adaptable en móviles, limitado a una sesión, con límite de tráfico, cifrado y auditoría. Abrir el terminal cierra la conversación antes de ocupar toda la pantalla.',
