  ...
  changelog: [
    {
      ...
      items: [
        'La colaboración remota ahora admite conversaciones trazables con agentes, inicio o restauración solo para Administradores y un terminal sin filtrar aprobado por separado, desactivado por defecto, limitado a una sesión, con límite de tráfico, cifrado y auditoría. El modal mantiene un tamaño estable y resalta claramente Invitación, Accesos y Auditoría.',
