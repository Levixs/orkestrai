  ...
  changelog: [
    {
      ...
      items: [
        'El panel Uso ahora actualiza Claude, Codex y Kimi automáticamente cada 5 minutos en lugar de cada 60 segundos, reduciendo llamadas innecesarias y el riesgo de respuestas HTTP 429.',
