...
export const DOCS_ES: DocsCatalog = {
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Agrega Dispositivo móvil al Canvas o ábrelo desde Workbench, conecta un iPhone o iPad Simulator disponible e instala una app del workspace. El mismo nodo persistente y la misma sesión continúan disponibles en ambas vistas. La pantalla completa se ajusta al panel por defecto; usa zoom, 1:1 y scroll en ambos ejes para inspeccionar detalles. Tú o un agente pueden tocar, deslizar, escribir, girar, cambiar permisos, inspeccionar el árbol de accesibilidad, capturar una pantalla y recopilar logs limitados manteniendo todos los artefactos dentro del proyecto.',
