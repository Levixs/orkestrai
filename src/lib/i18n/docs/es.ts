...
export const DOCS_ES: DocsCatalog = {
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Abre Diseño en la barra del Canvas y elige Tres direcciones completas de UI. Indica objetivo, público, plataforma, destino del código, restricciones, referencias y si Light y Dark son obligatorios. Orkestrai crea un grupo trazable con una spec vinculada, cinco etapas en Kanban y tres documentos Diseño nativos y editables: Claridad, Expresiva y Eficiente. Trabaja manualmente o delega la primera etapa a un líder que esté activo. Cada tarea enviada incluye la spec vinculada completa, imágenes, archivos y enlaces. Cada dirección debe entregar estados responsivos, tokens tipados, componentes reutilizables, prototipo navegable, evidencia de accesibilidad y calidad y una vista previa de código real del framework. Compara marca, UX, esfuerzo y riesgo técnico; una persona debe aprobar una dirección o combinación explícita antes de aplicar código. Finaliza validando la fuente aprobada contra un Portal o dispositivo móvil y registrando el resultado vinculado a Git en Review Center.',
  ...
  changelog: [
    {
      date: 'En desarrollo',
      items: [
        'El menú Diseño del Canvas ahora ofrece una exploración guiada con tres direcciones de UI. Una transacción crea una spec vinculada, cinco etapas trazables en Kanban y documentos nativos de Claridad, Expresiva y Eficiente; la ejecución manual o por el líder activo comparte el contrato completo de brief, referencias, tokens, componentes, prototipo, calidad y código, con aprobación humana explícita antes de implementar. Las notas vinculadas a tareas ahora se incluyen completas al enviar el trabajo.',
