...
export const DOCS_ES: DocsCatalog = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: `Agrega Diseño desde la barra del Canvas para crear un documento visual estructurado guardado en .orkestrai/designs dentro del proyecto. Haz doble clic en la vista previa o usa expandir para abrir el Modo Diseño; el mismo documento se abre como elemento completo de Workbench. Dibuja frames, rectángulos, elipses, texto y paths con Pluma en cualquier tamaño. Con Pluma, haz clic para crear esquinas, haz clic y arrastra para crear tangentes y haz clic en el primer punto para cerrar; termina un path abierto con Enter o doble clic. Selecciona un path para arrastrar anclas y manejadores Bézier, usa Shift para restringir el manejador a 45 grados, Alt para romper la tangencia, doble clic en un segmento para insertar un punto y convierte puntos entre Esquina y Suave en Propiedades. Usa Shift para seleccionar capas, alinear, distribuir, combinar por unión, resta, intersección o exclusión y crear o liberar máscaras. Apila rellenos y trazos sólidos o con gradiente lineal/radial; agrega sombras, blur, blend modes, reglas, guías persistentes y ajuste. Los frames admiten auto layout horizontal, vertical, con wrap o grid, padding y gaps, mientras las constraints de los hijos responden al redimensionamiento. Importa PNG, JPEG, WebP, GIF o SVG por selector, portapapeles o arrastrar y soltar, reutiliza el asset y exporta la página como SVG, PNG, JPEG, WebP o PDF. Todos los iconos de la barra tienen tooltip y los botones con flecha abren menús de opciones. Delete elimina el punto o las capas seleccionadas, Escape sale primero de la edición de puntos y deshacer/rehacer usa operaciones tipadas. Cada mutación registra una revisión e historial limitado; las miniaturas vinculadas a la revisión mantienen ligeras las vistas grandes del Canvas. Conecta el nodo Diseño al líder o especialista para que lea y edite el scene graph exacto mediante tools MCP tipadas de Orkestrai. Las ediciones humanas y de agentes usan control optimista de revisión, actualizan los editores en vivo y nunca requieren reescribir el JSON directamente.`,
    },
    {
      id: 'presets',
  ...
  changelog: [
    {
      date: 'En desarrollo',
      items: [
        'Los tooltips y menús del Modo Diseño ahora se muestran sobre el editor, y Pluma incorpora edición Bézier directa: arrastrar para crear tangentes, mover anclas y manejadores, dividir segmentos sin alterar su curva, convertir puntos Esquina/Suave y agregar o eliminar puntos con deshacer/rehacer.',
