  ...
  changelog: [
    {
      ...
      items: [
        ...
        'Portal has a real responsive-device viewport with a dedicated control rail, portaled preset selector, exact dimensions, orientation rotation, and contained scrolling that no longer hides controls or clips oversized pages.',
