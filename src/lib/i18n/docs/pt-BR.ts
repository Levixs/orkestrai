...
export const DOCS_PT: DocsCatalog = {
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Habilite o compartilhamento experimental, inicie uma sessão criptografada de ponta a ponta e escolha um convite para Navegador/celular ou App Orkestrai. O link web abre o PWA Remote instalável. O convite do app abre automaticamente o Orkestrai instalado; o convidado também pode usar Workspace → Entrar em workspace remoto e colar o convite. Ambos removem o segredo da URL antes da conexão e guardam uma chave de pareamento não extraível somente naquele dispositivo. Confira a impressão digital do dispositivo e escolha Leitor, Colaborador, Operador ou Administrador. O companion acompanha o estado do time, tarefas, revisões, atividade e uso dos providers; conforme a função, ele pode atualizar tarefas, decidir revisões ou enviar mensagens ao líder. Saída de terminal, arquivos, notas, portais, credenciais, tokens, URLs privadas e caminhos locais permanecem no host. Revogue um dispositivo ou encerre a sessão a qualquer momento e consulte comandos aceitos e rejeitados na auditoria.',
