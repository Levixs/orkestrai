...
export const DOCS_PT: DocsCatalog = {
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Habilite o compartilhamento experimental, inicie uma sessão criptografada de ponta a ponta e escolha um convite para Navegador/celular ou App Orkestrai. O link web abre o PWA Remote instalável. O convite do app abre automaticamente o Orkestrai instalado; o convidado também pode usar Workspace → Entrar em workspace remoto e colar o convite. Ambos removem o segredo da URL antes da conexão e guardam uma chave de pareamento não extraível somente naquele dispositivo. Confira a impressão digital e escolha Leitor, Colaborador, Operador ou Administrador. Um Operador pode manter uma conversa sanitizada e rastreável com um agente; um Administrador também pode iniciar ou restaurar um agente offline. O terminal bruto é uma permissão separada, exclusiva de Administrador naquele dispositivo, desativada por padrão, limitada a um terminal, com limite de tráfego, criptografia e auditoria. Ela não libera navegação de arquivos, visualização de Portal ou dispositivo mobile nem edição do Canvas. Revogue o dispositivo ou encerre a sessão a qualquer momento e consulte comandos aceitos e rejeitados na auditoria.',
      tags: ['PWA Remote criptografado', 'conversa segura com agente', 'terminal opt-in'],
    },
    {
      id: 'custom-app-theme',
  ...
  changelog: [
    {
      ...
      items: [
        'A colaboração remota agora permite conversas rastreáveis com agentes, início ou restauração exclusivo para Administrador e um terminal bruto aprovado separadamente, desativado por padrão, limitado a uma sessão, com limite de tráfego, criptografia e auditoria. A modal mantém tamanho estável e destaca claramente Convite, Acessos e Auditoria.',
