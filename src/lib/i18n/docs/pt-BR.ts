  ...
  changelog: [
    {
      ...
      items: [
        ...
        'O Portal ganhou nome persistente editável separado do endereço, automação por nome único ou id, inventário de todos os Portais do workspace com conexão explícita, reutilização de URLs repetidas e viewport responsivo real com rolagem contida.',
