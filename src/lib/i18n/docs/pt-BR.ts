  ...
  changelog: [
    {
      ...
      items: [
        ...
        'O Portal ganhou um viewport responsivo real com barra de controles dedicada, seletor de presets em portal, dimensões exatas, rotação e rolagem contida que não esconde mais os controles nem corta páginas maiores.',
